...
def send_reset_password_email(request, reset_req):
    subject = u'THUIR user behavior collector retrieve password'

    user = reset_req.user

    message = u'if you are %s, ' % user.username

    message += u'please click or copy this link to the browser to retrieve your password:'
